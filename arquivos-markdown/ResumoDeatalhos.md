...
pelo programadorEntão, abaixo segue uma série de atalhos que facilitam a vida dos desenvolvedores Java que utilizam
...
| Ctrl + Shift + P                 |                                 Seleciona o { ou } do seu codigo javaO cursor precisa estar entre as "{}" (Chaves)                                  |                      
